...
/**
 * OrderEntity(굿즈, 식음료 통합)의 데이터베이스 접근을 위한 레포지토리 인터페이스입니다.
 */
@Repository
public interface OrderRepository extends JpaRepository<OrderEntity, Long> {
     ...
     */
    List<OrderEntity> findByProductType(String productType);

    /**
     * 가용 재고(available_stock)가 0보다 큰, 즉 현재 구매 가능한 상품들만 조회합니다.
     */
    List<OrderEntity> findByAvailableStockGreaterThan(Integer stock);
}
