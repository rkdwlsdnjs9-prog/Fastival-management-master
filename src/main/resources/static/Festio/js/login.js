    ...
    loginForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          let successMsg = '로그인 되셨습니다.<br>편안한 행사정보 즐겨보세요!';

          if (isAdmin) {
            successMsg = '관리자 로그인 성공!<br>메인화면 상단의 [관리자 모드 전환] 버튼을 통해<br>관리 콘솔로 이동할 수 있습니다.';
          } else if (isStaff) {
            successMsg = '가맹점주(STAFF) 로그인 성공!<br>메인화면 상단의 [업주 모드 전환] 버튼을 통해<br>매장 관리 포털로 이동할 수 있습니다.';
          } else {
            successMsg = '로그인 되셨습니다.<br>편안한 행사정보 즐겨보세요!';
          }
